...
export const Loader: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center space-y-6 p-8 bg-zinc-900/50 rounded-2xl shadow-2xl border border-zinc-700/50 backdrop-blur-sm">
      <div className="w-16 h-16 border-4 border-t-4 border-zinc-600 border-t-white rounded-full animate-spin"></div>
      <h2 className="text-2xl font-semibold text-white">Generating Your Vibe...</h2>
